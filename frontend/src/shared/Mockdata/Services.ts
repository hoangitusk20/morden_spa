...
const services: Service[] = [
  ...
  detailDescription:
    "A relaxing nail care session that includes soaking, trimming, exfoliating, and polishing. Hands and feet are pampered with massage and moisturizers, leaving them soft, clean, and refreshed. Choose from a wide range of polish colors.",  category: "Nails",
},
{
  id: "6",
  title: "Body Scrub",
